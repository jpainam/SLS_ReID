...
flags.DEFINE_integer("input_height", 128, "The size of image to use (will be center cropped). [128]")
...
flags.DEFINE_integer("sample_size", 3600, "How much sample you want to output")
flags.DEFINE_integer("options", 1, "output option")
flags.DEFINE_integer("gan_set", 0, "Gan set")
flags.DEFINE_string("dataset", 'cluster_0', "The name of dataset [market1501, cuhk03, duke]")
