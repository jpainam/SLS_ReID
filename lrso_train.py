...
parser.add_argument('--name', default='lrso_dense2', type=str, help='output model name')
parser.add_argument('--data_dir', default='/home/paul/datasets/market1501/pytorch', type=str,
