...
if __name__ == '__main__':
    ...
    '''Returns: final_dist: re - ranked distance, numpy array, shape[num_query, num_gallery]
    evaluate then thes value
    '''
    ranked_list = re_ranking(q_g_dist, q_q_dist, g_g_dist)
    print(np.mean(ranked_list, axis=1))
